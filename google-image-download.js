...
async function main() {
    ...
    console.log(`Downloading ${partNumbers.length} accessories...`);
    ...
    for (const part of partNumbers) {
        ...
        const url = await searchImage(part);
